...
const TRACK_UNLOCK={
  ...
  jk17:        {cond:s=>(s.games||0)>=15,  hint:'10 parties jouées'},
  jk18:        {cond:s=>(s.xp||0)>=300,  hint:'300 XP requis'},
  jk19:        {cond:s=>(s.games||0)>=25,  hint:'20 parties jouées'},
  jk20:        {cond:s=>(s.xp||0)>=600,  hint:'600 XP requis'},
  jk21:        {cond:s=>(s.games||0)>=35,  hint:'30 parties jouées'},
  ...
  jk27:        {cond:s=>(s.games||0)>=65,  hint:'60 parties jouées'},
